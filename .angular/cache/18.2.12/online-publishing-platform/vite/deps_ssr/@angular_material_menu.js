...
} from "./chunk-X6CETNEU.js";
import {
  CommonModule,
  DOCUMENT,
  Location
} from "./chunk-ZE45J763.js";
import {
...
var OverlayRef = class {
  ...
  _detachContentWhenStable() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._ngZone.onStable.pipe((0, import_operators2.takeUntil)((0, import_rxjs3.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var MatMenuItem = class _MatMenuItem {
  constructor(_elementRef, _document, _focusMonitor, _parentMenu, _changeDetectorRef) {
    ...
    this._hovered = new import_rxjs4.Subject();
    this._focused = new import_rxjs4.Subject();
...
var MatMenuContent = class _MatMenuContent {
  constructor(_template, _componentFactoryResolver, _appRef, _injector, _viewContainerRef, _document, _changeDetectorRef) {
    ...
    this._document = _document;
    this._changeDetectorRef = _changeDetectorRef;
    this._attached = new import_rxjs4.Subject();
  }
  /**
...
var MatMenu = class _MatMenu {
  ...
  constructor(_elementRef, _ngZone, defaultOptions, _changeDetectorRef) {
    ...
    this._animationDone = new import_rxjs4.Subject();
  ...
  ngAfterContentInit() {
    ...
    this._directDescendantItems.changes.pipe((0, import_operators3.startWith)(this._directDescendantItems), (0, import_operators3.switchMap)((items) => (0, import_rxjs4.merge)(...items.map((item) => item._focused)))).subscribe((focusedItem) => this._keyManager.updateActiveItem(focusedItem));
  ...
  _hovered() {
    ...
    return itemChanges.pipe((0, import_operators3.startWith)(this._directDescendantItems), (0, import_operators3.switchMap)((items) => (0, import_rxjs4.merge)(...items.map((item) => item._hovered))));
  }
  /*
  ...
  focusFirstItem(origin = "program") {
    this._firstItemFocusSubscription?.unsubscribe();
    this._firstItemFocusSubscription = this._ngZone.onStable.pipe((0, import_operators3.take)(1)).subscribe(() => {
      let menuPanel = null;
  ...
  _updateDirectDescendants() {
    this._allItems.changes.pipe((0, import_operators3.startWith)(this._allItems)).subscribe((items) => {
...
var MatMenuTrigger = class _MatMenuTrigger {
  ...
  constructor(_overlay, _element, _viewContainerRef, scrollStrategy, parentMenu, _menuItemInstance, _dir, _focusMonitor, _ngZone) {
    ...
    this._closingActionsSubscription = import_rxjs4.Subscription.EMPTY;
    this._hoverSubscription = import_rxjs4.Subscription.EMPTY;
    this._menuCloseSubscription = import_rxjs4.Subscription.EMPTY;
  ...
  openMenu() {
    ...
    if (menu instanceof MatMenu) {
      ...
      menu._directDescendantItems.changes.pipe((0, import_operators3.takeUntil)(menu.close)).subscribe(() => {
    ...
    if (menu instanceof MatMenu) {
      ...
      if (menu.lazyContent) {
        menu._animationDone.pipe(
          (0, import_operators3.filter)((event) => event.toState === "void"),
          (0, import_operators3.take)(1),
          // Interrupt if the content got re-attached.
          (0, import_operators3.takeUntil)(menu.lazyContent._attached)
        ).subscribe({
  ...
  _menuClosingActions() {
    ...
    const parentClose = this._parentMaterialMenu ? this._parentMaterialMenu.closed : (0, import_rxjs4.of)();
    const hover = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0, import_operators3.filter)((active) => active !== this._menuItemInstance), (0, import_operators3.filter)(() => this._menuOpen)) : (0, import_rxjs4.of)();
    return (0, import_rxjs4.merge)(backdrop, parentClose, hover, detachments);
  }
  ...
  _handleHover() {
    ...
    this._hoverSubscription = this._parentMaterialMenu._hovered().pipe((0, import_operators3.filter)((active) => active === this._menuItemInstance && !active.disabled), (0, import_operators3.delay)(0, import_rxjs4.asapScheduler)).subscribe(() => {
      this._openedBy = "mouse";
      if (this.menu instanceof MatMenu && this.menu._isAnimating) {
        this.menu._animationDone.pipe((0, import_operators3.take)(1), (0, import_operators3.delay)(0, import_rxjs4.asapScheduler), (0, import_operators3.takeUntil)(this._parentMaterialMenu._hovered())).subscribe(() => this.openMenu());
      } else {
        this.openMenu();
      }
    });
